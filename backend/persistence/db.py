...
async def create_indexes() -> None:
    ...
    await db.tickets.create_index("tags")
    ...
    await db.csat_surveys.create_index("requester_id")
    await db.csat_surveys.create_index("technician_id")
    await db.csat_surveys.create_index("status")
    await db.csat_surveys.create_index("created_at")
